...
namespace WithClassSql_Crud2
{
    public partial class FormHastalar : Form
    {
        ...
        void Kaydet()
        {
            ...
            string cinsiyet =
                rdbKadin.Checked == true ? "K" : "E";
            string sorguCumlesi = $@"INSERT INTO tblHastalar VALUES 
                (
                    '{txtTcNo.Text}',
                    '{txtAd.Text}',
                    '{txtSoyad.Text}',
        ...
        {
            DialogResult cevap= MessageBox.Show("Silmek istedinizdiğinizden emin misiniz?", "DİKKAT!",MessageBoxButtons.YesNo);
